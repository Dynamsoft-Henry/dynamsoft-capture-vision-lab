...
public class ResultActivity extends AppCompatActivity {
	...
	private void fillViews(HashMap<String, String> properties) {
		...
		content.addView(childView("Date of Birth(YYYY-MM-DD):", properties.get("Date of Birth(YY-MM-DD)")));
		content.addView(childView("Date of Expiry(YYYY-MM-DD):", properties.get("Date of Expiry(YY-MM-DD)")));
	}
}